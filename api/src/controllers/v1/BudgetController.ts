...
export class BudgetController {
    static createUserBudget: ControllerRoute = {
    ...
    static getUserBudgets: ControllerRoute = {
        validation: checkSchema({
            UserId: {
                in: ['body'],
                isNumeric: true
        ...
        action: async (req: Request, res: Response, next: NextFunction) => {
            ...
            try {
                const logicResult:
                    LogicResult<BudgetDTO[]> = await BudgetBL.getUserBudgets(req.body);
    ...
    static updateBudget: ControllerRoute = {
        validation: checkSchema({
            BudgetId: {
                in: ['body'],
                isNumeric: true
